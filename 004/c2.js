...
(function($) {
  ...
  $.facebox.settings = {
    ...
    close_image   : '/images/fancy_closebox.png',
                ...
                <div class="popup"> \
                  <table>\
                    <tbody> \
                      ...
                      <tr> \
                        <td class="b"/></td> \
                        <td style="background:#81aa44; height:30px; font-size:13px; color:#fff; font-weight:bold;">\
                        	<div style="float:left; width:200px; padding:10px 14px;" align="left" id="faceboxTitle"></div>\
                            <div style="float:right; width:30px; padding-top:2px; padding-right:5px;"><a href="javascript:;" class="close"><img src="'+this.close_image+'" title="close" class="close_image" /></a> </div>\
                        </td> \
                        <td class="b"/></td> \
                      </tr>  \
                      <tr> \
...
$('#main-nav').css({'color':'yellow','background':'blue'});
